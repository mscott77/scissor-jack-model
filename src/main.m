...
p_sectionStockSelection = 'I1';         % see the function 'getSectionDimensions' for details on the options (I1, I2, I3, C1, C2, C3, R1, R2, R3)
...
% fileOutput = [datetime, ...
%                 sectionType_dv, num2str(W_section), num2str(H_section), num2str(t_section), num2str(p_pin_D), num2str(p_crossBar_D), ...
%                 num2str(F), num2str(Ld), num2str(Lv), num2str(Lcb_start), ...
%                 num2str(o_totalWeight), num2str(o_maxStress), o_maxStress_location, o_failureMode, o_failureModeLocation, num2str(o_failModeSafetyFactor), num2str(o_failureModeOrientation), ...
%                 num2str(SF_d_tearout_start), num2str(SF_d_tearout_end), num2str(SF_d_axial_start), num2str(SF_d_axial_end), num2str(SF_d_bearing_start), num2str(SF_d_bearing_end), ...
%                 num2str(SF_cb_bearing_start), num2str(SF_cb_bearing_end), num2str(SF_cb_buckling_start), num2str(SF_cb_buckling_end), ...
%                 num2str(SF_pin_shear_start), num2str(SF_pin_shear_end), num2str(SF_pin_bearing_start), num2str(SF_pin_bearing_end), ... 
%                 num2str(stress_cb_start), num2str(stress_d_start), num2str(stress_v_start), num2str(stress_cb_end), num2str(stress_d_end), num2str(stress_v_end), ...
%                 num2str(Fcb_start), num2str(Fd_start), num2str(Fv_start), num2str(Fcb_end), num2str(Fd_end), num2str(Fv_end)  
%              ];
