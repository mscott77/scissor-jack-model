function wasSuccessful = runSingleSimulation(p_pin_D, p_crossBar_D, p_sectionStockSelection, doPrintSummaryWindow)
    %RUNSINGLESIMULATION: Runs a single simulation of the scissor jack model
    %   p_pin_D: diameter of the pin (inches)
    %   p_crossBar_D: diameter of the cross bar (inches)
    %   p_sectionStockSelection: MUST BE A CHARACTER ARRAY ('') NOT A STRING ("") - options are C1,C2,C3,I1,I2,I3,R1,R2,R3
    %   doPrintSummaryWindow: boolean - if true, a summary window will be displayed with the results of the simulation
    ...
    % INPUT PARAMETERS DETERMINED AS FUNCTION INPUTS
